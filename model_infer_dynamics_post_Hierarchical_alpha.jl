...
model_infer_dynamics_post_Hierarchical(VAF,df_p,effect,p,master_curve,estInitJAK=true)
    ...
    Model function for infering VAF dynamics in the model post hierarchical using Turing - with alpha determining fraction of homozygous mutated cells
...
"""
@model function model_infer_dynamics_post_Hierarchical_alpha(VAF,df_p,effect,p,master_curve,estInitJAK=true)
