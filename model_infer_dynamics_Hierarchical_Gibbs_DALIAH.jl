"""
model_infer_dynamics_Hierarchical_Gibbs_DALIAH(VAF,df_p,effect,p,master_curve)
...
"""
@model function model_infer_dynamics_Hierarchical_Gibbs_DALIAH(VAF,df,effect,p,master_curve)
